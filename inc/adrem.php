...
//echo $where;
/*
if (is_null($add_arr["nam"])) {
    $nam = null;
} else {
    $nam = $add_arr["nam"];
}
if (is_null($add_arr["add1"])) {
    $add1 = null;
} else {
    $add1 = $add_arr["add1"];
}
if (is_null($add_arr["add2"])) {
    $add2 = NULL;
} else {
    $add2 = $add_arr["add2"];
}
if (is_null($add_arr["add3"])) {
    $add3 = NULL;
} else {
    $add3 = $add_arr["add3"];
}
if (is_null($add_arr["st"])) {
    $st = null;
} else {
    $st = $add_arr["st"];
}
if (is_null($add_arr["pc"])) {
    $pc = null;
} else {
    $pc = $add_arr["pc"];
}
if (is_null($add_arr["Ctc"])) {
    $Ctc = null;
} else {
    $Ctc = $add_arr["Ctc"];
}
if (is_null($add_arr["Ph"])) {
    $Ph = null;
} else {
    $Ph = $add_arr["Ph"];
}
