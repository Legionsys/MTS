...
UNION SELECT sCtc as nam,sPh as Ph,NULL as Em FROM `conNotes` WHERE CONCAT(ifnull(sCtc,''),ifnull(sPh,'')) like '%$stxt%'  
UNION SELECT rCtc as nam,rPh as Ph,NULL as Em FROM `conNotes` WHERE CONCAT(ifnull(rCtc,''),ifnull(rPh,'')) like '%$stxt%'  
UNION SELECT oCtc as nam,oPh as Ph,NULL as Em FROM `conNotes` WHERE CONCAT(ifnull(oCtc,''),ifnull(oPh,'')) like '%$stxt%'   limit 10;";
