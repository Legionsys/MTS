...
$sql = "SELECT snam as nam,sadd1 as add1,sadd2 as add2,sadd3 as add3,sst as st,spc as pc,sCtc as ct,sPh as ph FROM `conNotes` WHERE smrk is null and CONCAT(ifnull(snam,''),ifnull(sadd1,''),ifnull(sadd2,''),ifnull(sadd3,''),ifnull(sst,''),ifnull(spc,''),ifnull(sCtc,''),ifnull(sPh,'')) like '%$stxt%'
