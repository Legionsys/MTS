...
if (in_array($mrkr, array('client', 'contact'))) {
    ...
    if ($mrkr == 'client') {
        //$sql = "SELECT DISTINCT a.clientName,b.contd,b.contPh,b.contEm,b.contEm2,max(b.jobID) FROM clientList a LEFT JOIN jobList b on a.clientId = b.clientId WHERE a.act='1' and pmrk is null and ifnull(a.clientName,'') like '%$stxt%' Group by a.clientName,b.contd,b.contPh,b.contEm,b.contEm2 order by max(b.jobID) UNION SELECT DISTINCT a.clientName,b.contd,b.contPh,b.contEm,b.contEm2,max(b.jobID) FROM clientList a LEFT JOIN jobList b on a.clientId = b.clientId WHERE a.act='1' and pmrk is null  and ifnull(a.clientName,'') not like '%$stxt%' and CONCAT(ifnull(b.contd,''),ifnull(b.contPh,''),ifnull(b.cCtc,''),ifnull(b.cCtc2,'')) like '%$stxt%' Group by a.clientName,b.contd,b.contPh,b.contEm,b.contEm2 order by max(b.jobID) DESC limit 50;";
        $sql = "SELECT DISTINCT a.clientName,b.contd,b.contPh,b.contEm,b.contEm2,MAX(b.jobID) AS maxJobID FROM clientList a LEFT JOIN jobList b ON a.clientId = b.clientId WHERE a.act = '1' AND pmrk IS NULL GROUP BY a.clientName,b.contd,b.contPh,b.contEm,b.contEm2 HAVING (LOWER(a.clientName) LIKE '%$stxt%') OR (LOWER(a.clientName) NOT LIKE '%$stxt%' AND LOWER(CONCAT(IFNULL(b.contd, ''),IFNULL(b.contPh, ''),IFNULL(b.contEm, ''),IFNULL(b.contEm2, ''))) LIKE '%$stxt%') ORDER BY maxJobID DESC LIMIT 20;";
